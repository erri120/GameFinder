...
public class ValueTypeOrExceptionTests
{
    private const int TestValue = 1;
    private static ValueTypeOrException<int> CreateWithValue() => new(value: TestValue);

    private static (ValueTypeOrException<int>, Exception) CreateWithException()
    {
