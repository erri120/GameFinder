 ...
 */
const GOG_REGISTRY_PATH = 'HKEY_LOCAL_MACHINE\\Software\\WOW6432Node\\GOG.com\\Games';

/**
 * Parse a registry output value
 */
function parseRegistryValue(output: string, valueName: string): string | undefined {
